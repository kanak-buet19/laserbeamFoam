        ...
        while (Q > 1.0e-9)
        {
            ...
            if (myCellId != -1)
            {
                ...
                )
                {
                    ...
                    static scalar max_absorptivity = 0.0;
                    if (absorptivity > max_absorptivity)
                    {
                        max_absorptivity = absorptivity;
                        Info<< "Max absorptivity: " << max_absorptivity << " (Cell " << myCellId << ")" << endl;
                    }
