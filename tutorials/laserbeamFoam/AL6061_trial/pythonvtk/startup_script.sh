...
PROCESSOR_DIR="/users/PNS0496/kanakbuet19/CFD/test_small/processor1"
VTK_DIR="/users/PNS0496/kanakbuet19/CFD/test_small/testing/vtk"
...
test_environment() {
    ...
    # Check recon_test
    recon_dir="/users/PNS0496/kanakbuet19/CFD/test_small"
        ...
        if [ -d "$PROCESSOR_DIR" ]; then
            ...
            for dir in "${new_dirs[@]}"; do
                if ! grep -q "^$dir$" "$processed_log"; then
                    ...
                    cd "/users/PNS0496/kanakbuet19/CFD/test_small"
